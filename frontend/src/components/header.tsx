export function Header() {
  return (
    <header className="sticky top-0 z-50 bg-bg-primary/85 backdrop-blur-md border-b border-border w-full">
      <div className="max-w-7xl mx-auto px-6 py-7 flex items-center justify-center">
